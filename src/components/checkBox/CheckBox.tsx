    ...
    return (
        <div className='inline-flex items-start gap-4'>
            <div className="checkbox cursor-pointer relative" onClick={onClick} >
                <span className={`flex justify-center bg-primary p-1 rounded items-center w-5 h-5 ${!checked ? 'bg-white border-2 border-text3' : ''}`} >
                ...
                <input className="absolute inset-0 opacity-0"  {...field} type="checkbox" defaultChecked={field.value} name={name} />
            </div>
